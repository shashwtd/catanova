...
Keep the rules package independent of rendering, databases, sockets, and wall-clock time. Record random outcomes so a game can be replayed. Use the resource identifiers `wood`, `brick`, `sheep`, `wheat`, and `ore` throughout.
