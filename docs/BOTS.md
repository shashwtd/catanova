...
To let them think, set one key in the server environment:

```sh
OPENROUTER_API_KEY=...        # default route
AI_GATEWAY_API_KEY=...        # alternative, via Vercel AI Gateway
CATANOVA_BOT_MODEL=~typesafe/jev-latest
```
