...
Trading, incoming offers, help, match information, settings and development-card confirmation share warm brown surfaces, ivory labels and restrained gold controls. Trading uses the same receive-above-pay component in editable and read-only states. Once an offer is live, its editor is replaced by a row of players; selecting one and pressing Confirm completes the exchange. Accepted responses cannot be cancelled or repriced. No per-turn offer allowance is displayed or enforced.
